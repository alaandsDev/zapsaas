...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Sim. O Starter é grátis pra sempre, sem cartão. Você opera até 3 campanhas/mês, 50 leads no CRM e já tem o copiloto de IA da Wayvo em modo básico. Suficiente pra validar antes de pagar.",
  },
  {
    q: "Quanto custa o Pro e o que vem incluído?",
    a: "Pro custa R$ 47/mês: campanhas ilimitadas, 2 canais com balanceamento inteligente, CRM conversacional ilimitado, automação com IA que monta o fluxo pra você, receita rastreada por campanha, relatórios em tempo real e suporte prioritário. Assina pelo cartão, cancela quando quiser e sem fidelidade. Para volume alto ou API oficial da Meta, montamos uma proposta.",
  },
  {
