...
export default function Page() {
  return (
    ...
    <NicheLanding
      ...
      heroSubtitle="80% das vendas perdidas são por falta de follow-up. O ZapFlow nutri o lead, agenda a visita e mantém o contato quente — pra você só fechar."
      ...
      steps={[
        ...
        { title: "Importe seus leads e clientes", desc: "Da planilha, do CRM, da página de captura. ZapFlow organiza por interesse, perfil e estágio do funil." },
      ...
      testimonials={[
        ...
        { name: "Carla S.", role: "Imóveis de alto padrão · Florianópolis", quote: "No alto padrão o lead precisa ser cuidado por meses. O ZapFlow faz isso por mim com mensagem que parece pessoal. Já fechei 2 imóveis acima de R$ 2 mi com leads antigos.", color: "#8B5CF6" },
      ]}
      finalCTA={{
