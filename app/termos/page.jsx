...
const EMAIL   = "legal@wayvo.com.br";
    ...
    <div className="min-h-screen bg-[#0B1120] text-gray-300">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <Section num="1" title="Definições">
          ...
          <p><strong className="text-gray-200">Plataforma</strong> é o conjunto de ferramentas SaaS disponibilizadas em wayvo.com.br, incluindo disparos, automações, CRM de leads e integrações.</p>
        </Section>
