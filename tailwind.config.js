  ...
  theme: {
    extend: {
      colors: {
        ...
        card:    "#0F172A",
        border:  "#1E293B",
        primary: { DEFAULT: "#00FF88", hover: "#00E67A", dark: "#00CC6A" },
      ...
      boxShadow: {
        glow:      "0 0 0 1px rgba(0,255,136,0.2), 0 8px 32px -8px rgba(0,255,136,0.35)",
        "glow-sm": "0 0 0 1px rgba(0,255,136,0.15), 0 4px 16px -4px rgba(0,255,136,0.25)",
      ...
      backgroundImage: {
        "grid-fade": "radial-gradient(ellipse at top, rgba(0,255,136,0.06), transparent 60%)",
        "hero-glow": "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(0,255,136,0.12), transparent 60%)",
